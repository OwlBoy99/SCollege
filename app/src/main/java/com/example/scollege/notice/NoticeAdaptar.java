...
public class NoticeAdaptar  extends RecyclerView.Adapter<NoticeAdaptar.NoticeViewAdapter> {

    private Context context;
    private ArrayList<NoticeData> list;

    public NoticeAdaptar(Context context, ArrayList<NoticeData> list) {
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                reference.child(currentItem.getKey()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override                 //matches the key with notice uploaded to be deleted
                                ...
                                notifyItemRemoved(position);   //after deleting it will notify that recycler data is deleted
                            }
                        }
                );
