...
import com.example.scollege.Notice;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Computer Science", "Information Technology", "Physics","Chemistry","Zoology"};
    ...
    private void checkValidation(){
        ...
        if (name.isEmpty()) {
            ...
            Toast.makeText(this, "Please select anyone category", Toast.LENGTH_SHORT).show();
        }else if(bitmap==null){
